...
;              
CREATE USER IF NOT EXISTS "SA" SALT 'f6872f66a0c0ca9a' HASH '47d0e02feb7c0926e2e1fea620dcd6e41dae37b50b49a27c34d5895803f5f531' ADMIN;          
...
CREATE CACHED TABLE "PUBLIC"."TEAMS"(
    "TEAM_ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 33) NOT NULL,
...
INSERT INTO "PUBLIC"."USER_LICENSE_SETTINGS"("ID", "GRANDFATHERED_USER_COUNT", "GRANDFATHERED_USER_SIGNATURE", "GRANDFATHERING_LOCKED", "INTEGRITY_SALT", "LICENSE_MAX_USERS") VALUES(1, 5, '5:SsY512cN-div8-8rXYxSyRp_q3kNtEu_UE6X9yXwCeU', TRUE, 'f133bc90-6125-4dd6-b222-0365f11e065e', 0); 
...
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "CREATED_AT", "ENABLED", "FORCE_PASSWORD_CHANGE", "HAS_COMPLETED_INITIAL_SETUP", "IS_FIRST_LOGIN", "OAUTH_GRANDFATHERED", "PASSWORD", "ROLE_NAME", "SSO_PROVIDER", "SSO_PROVIDER_ID", "UPDATED_AT", "USERNAME", "TEAM_ID") VALUES(1, NULL, 'web', TIMESTAMP '2026-03-13 20:38:54.450525', TRUE, FALSE, FALSE, FALSE, FALSE, '$2a$10$pxzfiavuFG1IKt2HD3xWteNzkfIz5aTKA8FvjBv600Iaoq8mdC79i', NULL, NULL, NULL, TIMESTAMP '2026-03-13 20:42:03.394129', 'admin', 1);    
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "CREATED_AT", "ENABLED", "FORCE_PASSWORD_CHANGE", "HAS_COMPLETED_INITIAL_SETUP", "IS_FIRST_LOGIN", "OAUTH_GRANDFATHERED", "PASSWORD", "ROLE_NAME", "SSO_PROVIDER", "SSO_PROVIDER_ID", "UPDATED_AT", "USERNAME", "TEAM_ID") VALUES(2, '78937f14-878e-4312-b185-efd982eb50df', 'web', TIMESTAMP '2026-03-13 20:38:54.796605', TRUE, FALSE, FALSE, FALSE, FALSE, '$2a$10$fcSMS.gYAr2g4ncF7y96HeecwKIwnA5dihfdc4bNAq.fiG3g/ji9a', NULL, NULL, NULL, TIMESTAMP '2026-03-13 20:38:54.990989', 'STIRLING-PDF-BACKEND-API-USER', 2);          
